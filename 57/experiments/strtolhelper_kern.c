	...
	if (to == *val)
	{
        ...
        if (*testcase == 1)
        {
            ...
            if (curr != NULL)
            {
                ...
                ret = bpf_strtoul(curr, 1, base, &num);
                if (ret < 0)
                {
                    return 1;
                }
        ...
        if (*testcase == 2)
        {
            ret = bpf_probe_read_str(curr, 2, from);
            ...
            if (curr != NULL)
            {
                ...
                ret = bpf_strtoul(curr, 2, base, &num);
                if (ret < 0)
                {
                    return 1;
                }
        ...
        if (*testcase == 3)
        {
            ...
            if (curr != NULL)
            {
                ...
                ret = bpf_strtoul(curr, 4, base, &num);
                if (ret < 0)
                {
                    return 1;
                }
        ...
        if (*testcase == 4)
        {
            ret = bpf_probe_read_str(curr, 6, from);
            ...
            if (curr != NULL)
            {
                ...
                ret = bpf_strtoul(curr, 6, base, &num);
                if (ret < 0)
                {
                    return 1;
                }
        ...
        if (*testcase == 5)
        {
            ret = bpf_probe_read_str(curr, 8, from);
            ...
            if (curr != NULL)
            {
                ...
                ret = bpf_strtoul(curr, 8, base, &num);
                if (ret < 0)
                {
                    return 1;
                }
