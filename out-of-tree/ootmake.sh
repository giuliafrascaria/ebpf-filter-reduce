...
gcc -nostdinc "$USER".c common/bpf_load.c ~/thesis/libbpf/src/libbpf.a -I/usr/include/ -I/usr/include/linux/ \
	-I/usr/lib/gcc/x86_64-linux-gnu/7/include/ -I/usr/include/x86_64-linux-gnu/ -I/usr/include/x86_64-linux-gnu/bits/ -I/home/giogge/thesis/libbpf/src/ \
	-Icommon/ -Ikernel-usr-include/ -Itools/ -Itools/lib/ -Itools/include/ -Itools/perf/ -Itools/perf/util/ \
	-lelf -o compiled/$DEFAULT
