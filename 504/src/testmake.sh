...
gcc "$USER".c ../common/bpf_load.c ~/thesis/libbpf/src/libbpf.a -I/home/giogge/thesis/libbpf/include/uapi/ -I/home/giogge/thesis/libbpf/src/ -I../common/ -I/usr/src/linux-headers-`uname -r`/include/ -lelf -o compiled/$DEFAULT
